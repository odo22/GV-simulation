...
expdata = []
expdata = numpy.genfromtxt("expdata.txt",delimiter="\t")
expx = expdata[:,0]
expy = expdata[:,1]
...
def sample1():
    ...
    n0 = 1.00
    n1 = 1.68 + 0.06j
    n2 = 1.517+ 8800*ks + 0.14j
    n3 = 1.61 + 0.085j
    
    n_list = [n0, n1, n2, n1, n2, n1, n2, n1, n2, n1, n2, n1, n2, n3]
    '''

    material_nk_data2 = array([[0.0025, 1.58+0.15j], # @400nm
                              [0.002, 1.56+0.15j], # @500nm
                              [0.001667, 1.55+0.15j], # @600nm
                              [0.001429, 1.53+0.15j], # @700nm
                              [0.00125, 1.53+0.15j]]) # @800nm
    material_nk_fn2 = interp1d(material_nk_data2[:,0].real,
                              material_nk_data2[:,1], kind='quadratic')

    material_nk_data1 = array([[0.0025, 1.699+0.041j], # @400nm
                              [0.002, 1.6865+0.041j], # @500nm
                              [0.001667, 1.679361+0.041j], # @600nm
                              [0.001429, 1.67502+0.041j], # @700nm
                              [0.00125, 1.672203+0.041j]]) # @800nm
    ...
    for k in ks:
        ...
        n_list = [1, material_nk_fn1(k), material_nk_fn2(k), material_nk_fn1(k), material_nk_fn2(k), material_nk_fn1(k), material_nk_fn2(k), material_nk_fn1(k), material_nk_fn2(k), material_nk_fn1(k), material_nk_fn2(k), material_nk_fn1(k), material_nk_fn2(k),1.615+0.085j]
