...
def main():
    ...
    RNAmeans = numpy.zeros((N, lamb.size))
...
# Save simulation data in a text file made out of columns delimited by a space
    ...
    numpy.savetxt("/users/Olimpia/Desktop/datafile1.txt", RNAmeans, delimiter=" ")
...
def generateNlist(gray_list,lamb):
    ...
    for k in 1/lamb:
        ...
        nmelanin = AR2 + BR2*(k**2) + (AI2*numpy.exp(-1/(270*k)))*1j 
        qpigm = 1
